...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','nl.totalactivemedia.ti.pinnedcertcheck.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','NlTotalactivemediaTiPinnedcertcheckModuleAssets.m')
